      ...
      <aside className="p-4 h-auto">
        ...
        <div className="w-full md:hidden relative  p-2 mb-4">
          <RiCloseLine
            ...
            className="text-3xl  absolute top-2 sm:hover:rotate-[228deg] transition-transform font-bold right-2 sm:hover:text-[22px] text-[)] cursor-pointer"
          />
        </div>
        <p style={{ textAlign: "center", fontSize: "2rem" }}>Admin Panel</p>
        {/* Nav-menu */}
        <nav className="py-2">
          {nav.map((nav) => {
            return (
