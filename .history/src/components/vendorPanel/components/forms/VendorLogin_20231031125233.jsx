        ...
        >
          ...
          <section className="py-7 space-y-6">
            ...
            <form onSubmit={submitHandler}>
              ...
              {/* Password */}
              <div
                className="shadow-2xl sm:w-96  space-x-4 flex items-center w-64  p-2 rounded-md mt-3"
                style={{
                  color: "#fff",
                  borderColor: "#242424",
                  background: "#242424",
              ...
              <button
                type="submit"
                className="py-2 cursor-pointer tracking-wider bg-[#242424] text-[#fff] flex justify-center items-center w-full rounded-md font-medium mt-3  "
              >
                {loading ? (
