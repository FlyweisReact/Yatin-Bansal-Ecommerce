        ...
        <Modal.Body>
          <Form onSubmit={postData}>
            <Form.Group className="mb-3">
              <input type="radio" id="html" name="fav_language" onClick={() => setDriver(true)} style={{marginRight : '10px'}} />
              <label for="html" style={{marginRight : '10px'}} >Driver</label>
              <input type="radio" id="css" name="fav_language" onClick={() => setDriver(false)} style={{marginRight : '10px'}}  />
              <label for="css" style={{marginRight : '10px'}} >User</label>
            </Form.Group>


          <Form.Select className="mb-3" onChange={() => setUserId()} >
            <option>Select Your Prefrence</option>
            <option value={"6513cb033657100ef815a650"} > 6513cb033657100ef815a650 </option>
          </Form.Select>
